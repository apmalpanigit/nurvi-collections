...
const Header: React.FC = () => {
  ...
  const navLinkClass = ({ isActive }: { isActive: boolean }): string =>
    `text-lg font-medium transition-colors duration-200 ${isActive ? 'text-indigo-600' : 'text-gray-600 hover:text-indigo-600'}`;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <NavLink to="/products/clothes" className={navLinkClass}>Clothes</NavLink>
            <NavLink to="/products/mens" className={navLinkClass}>Men's</NavLink>
            <NavLink to="/products/womens" className={navLinkClass}>Women's</NavLink>
          </nav>
